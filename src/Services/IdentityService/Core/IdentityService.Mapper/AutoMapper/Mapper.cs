...
namespace IdentityService.Mapper.AutoMapper
{
    public class Mapper : Application.Interfaces.AutoMapper.IMapper
    {
        ...
        protected void Config<TDestination, TSource>(int depth = 5, string? ignore = null)
        {
            ...
            if (typePairs.Any(tp => tp.DestinationType == typePair.DestinationType && tp.SourceType == typePair.SourceType) && ignore is null) return;
